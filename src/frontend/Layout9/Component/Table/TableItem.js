...
import { deleteItemRule, updateRules, changeIsLoadedRules, saveLog, saveLogObject } from "../../../Constant/ActionType";
...
class TableItem extends Component {
  ...
  onMultiDelete = () => {
    ...
    for (let i = 0; i < selectedRow.length; i++) {
      ...
      this.props.onSaveLog("Nguyen Van A", getCurrTime(), `Xóa quy định chung: ${ruleitems[selectedRow[i]].content}`, this.props.logReducer.contentTab, this.props.subjectId)
      this.props.onSaveReducer("Nguyen Van A", getCurrTime(), `Xóa quy định chung: ${ruleitems[selectedRow[i]].content}`, this.props.logReducer.contentTab, this.props.subjectId)
  ...
  handleDelete(index) {
    ...
    this.props.onSaveLog("Nguyen Van A", getCurrTime(), `Xóa quy định chung: ${ruleitems[index].content}`, this.props.logReducer.contentTab, this.props.subjectId)
    this.props.onSaveReducer("Nguyen Van A", getCurrTime(), `Xóa quy định chung: ${ruleitems[index].content}`, this.props.logReducer.contentTab, this.props.subjectId)
  ...
  onSaveEdit(form, index) {
    form.validateFields((error, row) => {
      ...
      this.props.onSaveLog("Nguyen Van A", getCurrTime(), `Chỉnh sửa quy định chung : ${item.content} -> ${newRules[index].content}`, this.props.logReducer.contentTab, this.props.subjectId)
      this.props.onSaveReducer("Nguyen Van A", getCurrTime(), `Chỉnh sửa quy định chung : ${item.content} -> ${newRules[index].content}`, this.props.logReducer.contentTab, this.props.subjectId)
