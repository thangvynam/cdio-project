...
class MenuLeft extends Component {
    ...
    redirect = () => {
        ...
        this.props.content_monhoc === undefined)) {
            return <Redirect to={`/${this.props.content_type}/${this.props.content_ctdt}/${this.props.content_khoi}/${this.props.subjectId}/thong-tin-chung`}/>
        }
    ...
    || this.props.content_tab === undefined) && this.checkSubjectExist(this.props.content_monhoc) === true) {
        return <Redirect to={`/${this.props.content_type}/${this.props.content_ctdt}/${this.props.content_khoi}/${this.props.content_monhoc}/thong-tin-chung`}/>
    }
    }
    ...
    render() {
        ...
        <Menu
                ...
                : this.props.content_monhoc !== "" && this.props.content_monhoc !== undefined ? [this.props.content_monhoc]
