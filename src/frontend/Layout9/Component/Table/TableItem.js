...
ruleitems[j].del_flag = 1;
 this.props.onSaveLog("Nguyen Van A", getCurrTime(), `Xóa quy định chung: ${ruleitems[j].content}`, this.props.logReducer.contentTab, this.props.subjectId)
      this.props.onSaveReducer("Nguyen Van A", getCurrTime(), `Xóa quy định chung: ${ruleitems[j].content}`, this.props.logReducer.contentTab, this.props.subjectId)
